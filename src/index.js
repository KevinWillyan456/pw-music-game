...
const containerTarget = document.querySelector('.main-container .container-game .container')
const livePointer = document.querySelector('.content-info .box .live .pointer-live')
const livePointerMobile = document.querySelector('.live-mobile .pointer-live-mobile')
...
let data = [
  ...
  },
  {
    ...
    songUrl: 'https://pw-music-game-db.netlify.app/resources/nightcore%20-%20bad%20boy.mp3',
  ...
  {
    songTitle: 'Kamaz AMV',
    songUrl: 'https://pw-music-game-db.netlify.app/resources/kamaz%20amv.mp3',
  ...
  },
  {
    ...
    songUrl: 'https://pw-music-game-db.netlify.app/resources/nightcore%20-%20%C3%A9lan.mp3',
  ...
  },
  {
    ...
    songUrl: 'https://pw-music-game-db.netlify.app/resources/[%20amv%20]%20shivers.mp3',
  ...
  {
    songTitle: 'Loli God Requiem Shigure UI / Astronaut in the ocean (Bemax Cover Remix) [AMV]',
    songUrl:
  ...
  },
  {
    ...
    songUrl: 'https://pw-music-game-db.netlify.app/resources/gate%20amv%20-%20cocaine%20loli.mp3',
  ...
  {
    songTitle: 'Nightcore - Can You Feel My Heart (Female Version) (Lyrics)',
    songUrl:
...
const screenFlashlight = document.querySelector('.main-container .screen-flashlight')

// elementos do container home
const containerHome = document.querySelector('.main-container .container-home')
const containerHomeLogo = document.querySelector('.main-container .container-home .logo')

// elementos do container select
const containerSelect = document.querySelector('.main-container .container-select')
const containerSelectBackBtn = document.querySelector('.container-select .btn-back-select')
const containerSelectPlayBtn = document.querySelector('.container-select .btn-select-play')
const containerSelectOptionsBtn = document.querySelector('.container-select .btn-select-options')

// elementos do container songs
const containerSongs = document.querySelector('.main-container .container-songs')
const containerSongsBackBtn = document.querySelector('.container-songs .btn-back-songs')
...
const containerConfig = document.querySelector('.main-container .container-config')
const containerConfigBackBtn = document.querySelector('.container-config .btn-back-config')
...
const containerGameFailedExitBtn = document.querySelector('.container-failed .box .exit')

const containerGamePausedRetryBtn = document.querySelector('.container-paused-option-retry')
const containerGamePausedExitBtn = document.querySelector('.container-paused-option-exit')
const containerGamePausedResumeBtn = document.querySelector('.container-paused-option-resume')
...
const containerSongCompleted = document.querySelector('.main-container .container-song-completed')
const containerSongCompletedRetryBtn = document.querySelector('.container-song-completed .retry')
const containerSongCompletedExitBtn = document.querySelector('.container-song-completed .exit')
const songPerfect = document.querySelector('.main-container .container-song-completed .perfect')

// elementos do song preview details
const songPreviewDetails = document.querySelector('.song-preview-details')
const songPreviewDetailsStopBtn = document.querySelector('.song-preview-details-stop-btn')
const songPreviewDetailsPlayBtn = document.querySelector('.song-preview-details-play-btn')
...
function loadSong(songChange) {
  ...
  document
    .querySelectorAll('.main-container .container-songs .content-songs .song')
    .forEach((song) => {
...
function setSong(songChange) {
  ...
  song.play()
  containerGame.style.setProperty('background-image', `url("${songChange.songCover}")`)
  ...
  containerSongCompleted.style.setProperty('background-image', `url("${songChange.songCover}")`)
}
...
song.addEventListener('ended', () => {
  ...
  document.querySelector('.main-container .container-song-completed .points').textContent =
    `Points: ${totalPoints}`
  ...
  document.querySelector('.main-container .container-song-completed .difficulty').textContent =
    `Difficulty: ${difficulty}`
  document.querySelector('.main-container .container-song-completed .accuracy').textContent =
    `Accuracy: ${(((totalNotesPassed * 100) / (totalNotes + totalNotesPassed) - 100) * -1).toFixed(
      2,
    )}%`
...
function prepareActionTrailsForMobile() {
  ...
  if (difficulty === 'Easy' || difficulty === 'Medium') {
    document.querySelector('.main-container .container .trails .trail-1').style.height = '50vh'
    document.querySelector('.main-container .container .trails .trail-2').style.height = '50vh'
    document.querySelector('.main-container .container .trails .trail-3').style.height = '50vh'
    document.querySelector('.main-container .container .trails .trail-4').style.height = '50vh'
  } else {
    document.querySelector('.main-container .container .trails .trail-1').style.height = '100vh'
    document.querySelector('.main-container .container .trails .trail-2').style.height = '100vh'
    document.querySelector('.main-container .container .trails .trail-3').style.height = '100vh'
    document.querySelector('.main-container .container .trails .trail-4').style.height = '100vh'
  }
}
...
function livePointerEvents() {
  ...
  if (livePoints <= 33) {
    document.querySelector('.content-info .box .live .live-part-green').classList.remove('hovered')
    document.querySelector('.content-info .box .live .live-part-yellow').classList.remove('hovered')
    document.querySelector('.content-info .box .live .live-part-red').classList.add('hovered')

    document.querySelector('.live-mobile .live-part-green-mobile').classList.remove('hovered')
    document.querySelector('.live-mobile .live-part-yellow-mobile').classList.remove('hovered')
    document.querySelector('.live-mobile .live-part-red-mobile').classList.add('hovered')
  } else if (livePoints >= 66) {
    document.querySelector('.content-info .box .live .live-part-red').classList.remove('hovered')
    document.querySelector('.content-info .box .live .live-part-yellow').classList.remove('hovered')
    document.querySelector('.content-info .box .live .live-part-green').classList.add('hovered')

    document.querySelector('.live-mobile .live-part-red-mobile').classList.remove('hovered')
    document.querySelector('.live-mobile .live-part-yellow-mobile').classList.remove('hovered')
    document.querySelector('.live-mobile .live-part-green-mobile').classList.add('hovered')
  } else {
    document.querySelector('.content-info .box .live .live-part-red').classList.remove('hovered')
    document.querySelector('.content-info .box .live .live-part-green').classList.remove('hovered')
    document.querySelector('.content-info .box .live .live-part-yellow').classList.add('hovered')

    document.querySelector('.live-mobile .live-part-red-mobile').classList.remove('hovered')
    document.querySelector('.live-mobile .live-part-green-mobile').classList.remove('hovered')
    document.querySelector('.live-mobile .live-part-yellow-mobile').classList.add('hovered')
  }
  if (livePoints <= 20) {
...
function totalPointsEvents() {
  document.querySelector('.content-info .box .score').textContent = totalPoints
}
function totalNotesEvents() {
  const formattedTotalNotes = String(totalNotes).padStart(3, '0')
  document.querySelector('.content-info-2 .box .notes-count').textContent = formattedTotalNotes
  document.querySelector('.rate-mobile .notes-count').textContent = formattedTotalNotes
}
...
function pauseCounting() {
  ...
  counterToStart.style.display = 'flex'
  counterToStart.textContent = 3
  document.querySelector('.main-container .container-paused').style.display = 'none'
...
function controllerFailed() {
  ...
  document.querySelector('.main-container .container-failed').style.display = 'flex'
}

let timerConsecutiveHits = null
function consecutiveHitsEvents() {
  if ((consecutiveHits % 50 === 0 && consecutiveHits !== 0) || consecutiveHits === 20) {
...
function controllerRateBars() {
  ...
  function divideAndExecute(num) {
    ...
    const rightPart = numString.length === 1 ? Number(numString) : Number(numString.charAt(1))
  ...
  function functionForZeroLeftPart(rightPart) {
    ...
    document.querySelector('.content-info-2 .box .multiplicator-n').textContent = 1
  ...
  function functionForOneLeftPart(rightPart) {
    ...
    document.querySelector('.content-info-2 .box .multiplicator-n').textContent = 2
  ...
  function functionForTwoLeftPart(rightPart) {
    ...
    document.querySelector('.content-info-2 .box .multiplicator-n').textContent = 4
  ...
  function functionForThreeLeftPart(rightPart) {
    ...
    document.querySelector('.content-info-2 .box .multiplicator-n').textContent = 8
...
function gamePause() {
  ...
  if (gamePaused === false) {
    ...
    canActions = false
    song.pause()
    document.querySelector('.main-container .container-paused').style.display = 'flex'
    songEffectClick()
  } else {
    pauseCounting()
    songEffectClick()
...
function gameRetry() {
  ...
  setScreenFlashlight()
  songEffectClick()
  document.querySelector('.main-container .container-failed').style.display = 'none'
...
function gameSongPreview(songChange) {
  ...
  document.querySelector('.song-preview-details-title-song').textContent =
    `Song title: ${songChange.songTitle}`

  setPreviewDifficulty(selectDifficulty)

  document.querySelector('.song-preview-details-duration').textContent = 'Song duration: --:--'
...
function gameSongPreviewStop() {
  ...
  document.querySelector('.song-preview-details.exit').addEventListener('animationend', (event) => {
    if (event.animationName === 'animation-song-preview-details-exit') {
      songPreviewDetails.style.display = 'none'
      document.querySelector('.song-preview-details').classList.remove('exit')
    }
  })
  songEffectClick()
}
...
function songPreviewDetailsClose() {
  ...
  document.querySelector('.song-preview-details').addEventListener('click', () => {
    if (document.querySelector('.song-preview-details').classList.contains('hide')) {
...
function setPreviewDifficulty(selectDifficulty) {
  ...
  if (difficulty === 'Easy') {
    document
      .querySelectorAll('.difficulty-expert, .difficulty-hard, .difficulty-medium')
      .forEach((difficulty) => {
  ...
  if (difficulty === 'Medium') {
    document
      .querySelectorAll('.difficulty-expert, .difficulty-hard, .difficulty-easy')
      .forEach((difficulty) => {
        difficulty.classList.remove('selected')
      })
    document.querySelectorAll('.difficulty-medium').forEach((difficulty) => {
      difficulty.classList.add('selected')
    })
  }
  ...
  if (difficulty === 'Hard') {
    document
      .querySelectorAll('.difficulty-expert, .difficulty-easy, .difficulty-medium')
      .forEach((difficulty) => {
        difficulty.classList.remove('selected')
      })
  ...
  if (difficulty === 'Expert') {
    document
      .querySelectorAll('.difficulty-easy, .difficulty-hard, .difficulty-medium')
      .forEach((difficulty) => {
        difficulty.classList.remove('selected')
      })
    document.querySelectorAll('.difficulty-expert').forEach((difficulty) => {
      difficulty.classList.add('selected')
    })
  }

  document.querySelector('.song-preview-details-difficulty').textContent =
...
function searchSong(value) {
  ...
  dataFiltered.forEach((song) => {
    document.querySelector(`.song[style*="${song.songCover}"]`).style.display = 'flex'
  })
}
function getLevel() {
  ...
  if (levelLocalStoraged && experienceLocalStoraged) {
    ...
    contentLevelBarFill.style.width = `${(experience / actualExperience()) * 100}%`
...
function songEffectClick() {
  const audio = new Audio('https://pw-music-game-db.netlify.app/sounds/clicked.mp3')
...
function songEffectCompleted() {
  const audio = new Audio('https://pw-music-game-db.netlify.app/sounds/completed.mp3')
  audio.volume = soundEffectsVolume
  audio.play()
}

function songEffectMissed() {
  const audio = new Audio('https://pw-music-game-db.netlify.app/sounds/missed.mp3')
  audio.volume = soundEffectsVolume
  audio.play()
}
