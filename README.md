...
- **No computador**: Utilize as teclas `D`, `F`, `J` e `K` para acionar as notas conforme elas se aproximam do alvo na tela.
- **No celular**: Toque nas áreas correspondentes à posição das notas.
...
<div style="display: flex; flex-direction: column; align-items: center">
    <img
        ...
        alt="Tela de seleção de músicas na versão mobile"
        style="width: 300px"
    />
    <p style="font-style: italic; margin-top: 10px">
...
<div style="display: flex; flex-direction: column; align-items: center">
    <img
        ...
        alt="Tela do jogo na versão mobile"
        style="width: 300px"
    />
    <p style="font-style: italic; margin-top: 10px">
